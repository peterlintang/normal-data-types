...
//    printf("%s: config pressure\n", __func__);
    spl06_config_pressure(PM_RATE_4,PM_PRC_64);
//    printf("%s: config tmp\n", __func__);
    spl06_config_temperature(PM_RATE_4,TMP_PRC_1);
...
int get_mag_data(struct mag_data_t *data)
{
...
K_THREAD_STACK_DEFINE(mcal_stack_area, 1024);
