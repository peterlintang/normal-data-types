...
#line 12 "SimpleCal.y"
                       { printf("= %d\n",yyvsp[-1]); }
#line 1072 "SimpleCal.tab.c"
    break;

  case 5: /* exp: exp ADD factor  */
#line 16 "SimpleCal.y"
                    { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1078 "SimpleCal.tab.c"
    break;

  case 6: /* exp: exp SUB factor  */
#line 17 "SimpleCal.y"
                    { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1084 "SimpleCal.tab.c"
    break;

  case 8: /* factor: factor MUL term  */
#line 21 "SimpleCal.y"
                        { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1090 "SimpleCal.tab.c"
    break;

  case 9: /* factor: factor DIV term  */
#line 22 "SimpleCal.y"
                        { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1096 "SimpleCal.tab.c"
    break;

  case 11: /* term: ABS term  */
#line 26 "SimpleCal.y"
               { yyval = yyvsp[0] >= 0?yyvsp[0]:-yyvsp[0]; }
#line 1102 "SimpleCal.tab.c"
    break;


#line 1106 "SimpleCal.tab.c"
