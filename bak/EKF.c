...
{
	oo[0] = atan2(2*(q1*q2 + q0*q3), 1 - 2 * (q2 * q2 + q3 * q3)) ;
	oo[1] = asin(-2 * q1 * q3 + 2 * q0* q2); 
	oo[2] = atan2(2 * q2 * q3 + 2 * q0 * q1,-2 * q1 * q1 - 2 * q2* q2 + 1); 
