...
void iecompass(Int16 iBpx, Int16 iBpy, Int16 iBpz,
...
//	return iLPPsi; 
	return (int32_t)iLPPsi > 0 ? (int32_t)iLPPsi: 360 * 100 + (int32_t)iLPPsi;
}

int32_t get_iPsi(void)
{
	return (int32_t)iPsi > 0 ? (int32_t)iPsi : 360 * 100 + (int32_t)iPsi;
}
/*
